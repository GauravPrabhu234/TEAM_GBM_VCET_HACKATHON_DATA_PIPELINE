...
INFLUX_API_TOKEN = "eQqsK0quoaIUeQFfVYqxTYHq1zBiseK2LCx7o0NX_wc_0Y0vwqk1SeR3svrEWXg8_jH77zRko97I4eEaL-zI7w==" # Make sure this is still the correct token
...
def get_status(metric_type, value):
    """Analyzes a sensor reading and returns its status."""
...
print("Listening for messages with ANALYTICS... Press Ctrl+C to stop.")
try:
    while True:
        ...
        try:
            ...
            # *** UPDATED: Add the new status tag to the data point ***
